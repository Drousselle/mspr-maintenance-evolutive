# Generated by Django 3.2.4 on 2021-06-06 13:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(max_length=10, unique=True, verbose_name='date')),
                ('horaire_debut', models.CharField(max_length=10, verbose_name='heure debut')),
                ('horaire_fin', models.CharField(max_length=10, verbose_name='heure fin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('horaire_debut', models.CharField(max_length=10, verbose_name='Horaire debut')),
                ('horaire_fin', models.CharField(max_length=10, verbose_name='Horaire fin')),
